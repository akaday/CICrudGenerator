...
{   
    ...
    {   
        ...
        redirect(site_url('owner/perusahaan/update/1'));

        $perusahaan = $this->perusahaan_model->get_all();
        
        //DATA
        $data['perusahaan_data']         = $perusahaan;
        $data['folder_admin']            = $this->admin_folder;
        $data['content_header']          = 'data perusahaan List';
        $data['content_header_small']    = '';
        $data['breadcrumb_active']       = '<li class=active>data perusahaan</li>';
        $data['show_username']           = $this->session->userdata('namauser');
        

        $element = $this->admin_folder."perusahaan_list";
        //View
    ...
    public function read($id) 
    {
		...
		'logo' => $row->logo,
            ...
            //DATA
            $data['folder_admin']            = $this->admin_folder;
            $data['content_header']          = 'perusahaan';
            $data['content_header_small']    = '';
            $data['breadcrumb_active']       = '<li class=active>perusahaan</li>';
            $data['show_username']           = $this->session->userdata('namauser');
            

            $element = $this->admin_folder."perusahaan_read";
            //View
            template_lib($element, $data, '', $this->admin_folder);

        } else {
            $this->session->set_flashdata('message', 'Data Tidak Ditemukan');
            redirect(site_url('owner/perusahaan'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('owner/perusahaan/create_action'),
        ...
        //DATA
        $data['folder_admin']            = $this->admin_folder;
        $data['content_header']          = 'perusahaan Create';
        $data['content_header_small']    = '';
        $data['breadcrumb_active']       = '<li class=active>perusahaan</li>';
        $data['show_username']           = $this->session->userdata('namauser');
        

        $element = $this->admin_folder."perusahaan_form";
        //View
        template_lib($element, $data, '', $this->admin_folder);
    }
    ...
    {   
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('owner/perusahaan/update_action'),
            ...
            //DATA
            $data['folder_admin']            = $this->admin_folder;
            $data['content_header']          = 'data perusahaan';
            $data['content_header_small']    = '';
            $data['breadcrumb_active']       = '<li class=active>data perusahaan</li>';
            $data['show_username']           = $this->session->userdata('namauser');
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //     else
            //     {   // case - success
            //         $foto_lama = $this->perusahaan_model->get_by_id($this->input->post('id_perusahaan', TRUE))->logo;
            //         if(!empty($foto_lama))
            //         {   //echo $foto_lama;
