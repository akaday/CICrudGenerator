...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2016 at 01:28 AM
...
('admin', 'e10adc3949ba59abbe56e057f20f883e', '4297f44b13955235245b2497399d7a93', 'Administrator', 'admin@detik.com', '08238923848', '1', 'N', '34f9274f3a088e2a6d0cc7706aa397f11a04ca0a', 'false'),
('mctosima', '92cf3b6647282bdf7014979c00d28e72', '', 'Martin', 'mctosima@gmail.com', '085770256256', '1', 'N', 'd66e82513aced3c9d6c4361393dbb07de2807fd8', 'false');
...
(1, 'superadmin', '|all|', '-', 0),
(2, 'admin', '|tentang_perusahaan||artikel_kategori|artikel|album|gallery|0|identitas/update/1.html|perusahaan|users|', '-', 0),
(3, 'member', '', '', 0);
...
--
ALTER TABLE `module`
  MODIFY `id_main` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
--
